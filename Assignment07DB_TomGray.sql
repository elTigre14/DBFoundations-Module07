--*************************************************************************--
-- Title: Assignment07_TomGray
-- Author: Tom Gray
-- Desc: This file demonstrates how to use Functions
-- Change Log: When,Who,What
-- 2021-02-28,tgray,Created File for Asssignment 07 + Updted DB names
--**************************************************************************--
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment07DB_TomGray')
	 Begin 
	  Alter Database [Assignment07DB_TomGray] set Single_user With Rollback Immediate;
	  Drop Database Assignment07DB_TomGray;
	 End
	Create Database Assignment07DB_TomGray;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment07DB_TomGray;
...
-- By using the Format pattern of 'C' we will return a currency format result. By defining the 
-- culture of 'en-US' we will return currency results, in US dollars.
...
-- This is similar to the first question, I am still using the Format function to return USD
-- formatting. With the addition of an inner join, I can also return the Category Name associated
-- with each product. Lastly, ordering the results by Category + Product

Select CategoryName, P.ProductName , Format(UnitPrice, 'C', 'en-US') as [UnitPrice]
  From vProducts as P 
...
-- Below I am creating my view with proper formatting, and joining the necessary tables to do so.
...
-- Testing my new view and ordering by Product, Date, and Count
...
-- This one took me quite a while, I didnt really understand the Lag command until watching the videos over 
-- and doing my own research on the web. This was a challenging one =)
...
As
  ...
  ,[PreviousMonthCount] = 
	 ...
	 Lag([Count]) Over(Order By ProductName, Month([InventoryDate])))
...
Select * From fProductInventoriesWithPreviousMonthCountsWithKPIs(1) Order By Year(Cast(InventoryDate as Date));
Select * From fProductInventoriesWithPreviousMonthCountsWithKPIs(0) Order By Year(Cast(InventoryDate as Date));
Select * From fProductInventoriesWithPreviousMonthCountsWithKPIs(-1) Order By Year(Cast(InventoryDate as Date));
Go
